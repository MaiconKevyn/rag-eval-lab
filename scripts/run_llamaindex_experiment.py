#!/usr/bin/env python
"""CLI: run one LlamaIndex RAG experiment and persist run_results.json."""
...
from rag_eval_lab.llamaindex.runner import run_llamaindex_experiment
...
def main(
    ...
    rebuild: bool = typer.Option(False, "--rebuild", help="Delete and re-ingest the Pinecone namespace."),
    max_questions: int | None = typer.Option(None, "--max-questions", help="Limit QA pairs evaluated."),
    ...
    typer.echo("")
    typer.echo("── LlamaIndex Run Report ────────────────────────")
